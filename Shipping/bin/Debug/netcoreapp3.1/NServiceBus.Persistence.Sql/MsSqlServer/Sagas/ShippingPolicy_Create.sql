...
begin
  ...
  alter table ' + @tableName + N'
    add Correlation_OrderId nvarchar(200);';
...
if (@dataType_OrderId <> 'nvarchar')
  begin
    declare @error_OrderId nvarchar(max) = N'Incorrect data type for Correlation_OrderId. Expected nvarchar got ' + @dataType_OrderId + '.';
